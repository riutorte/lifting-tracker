...
- **Full planning doc set** in `~/lifting-tracker/docs/`:
  ...
  - `lift-track-architecture_v0.4.0.md` — 24 decisions (D1–D24), full data model with 30+ tables
  - `lift-track-user-stories_v0.2.0.md` — 114 user stories, MVP through v4+
  - `lift-track-themes-epics-features_v0.2.0.md` — 8 themes, 31 epics, 109 features
  - `lift-track-roadmap_v0.4.0.md` — 8 MVP sprints with Kanban tables, dependencies, sizing
  - `lift-track-effort-estimate_v0.1.0.md` — calendar time estimates (MVP ~6 months at 10–15 hrs/week)
