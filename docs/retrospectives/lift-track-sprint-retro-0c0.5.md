...
- `docs/lift-track-kanban-sprint-0c0.5.md` — closed-state finalized; CC8 marked MOVED with rationale
- `docs/lift-track-kanban-sprint-0c2.md` — draft per CC4
- `docs/lift-track-kanban-sprint-0d.md` — draft per CC5; CC3a (attack-vector mapping as research/prep) retained; CC3b re-sequenced out to post-Sprint-0d1 placement; CC8 install does NOT land in 0d (deferred to post-0d2)
- `docs/lift-track-kanban-sprint-0e.md` — draft per CC6
- `docs/retrospectives/lift-track-sprint-retro-0c0.5.md` — this file
...
**Close criteria (10 items):** see `docs/lift-track-kanban-sprint-0c1.md`. CC1 (CONVENTIONS amendments) is now satisfied by 0c0.5 close commit and inherits to 0c1 as DONE.
