...
- **DoDAF cross-reference matrix v0.1.0** — `docs/lift-track-dodaf-cross-reference.md` 611 lines, 8 sections, mermaid dependency graph, 12 defects surfaced honestly. Closes CONVENTIONS §11.6 commitment. Commit `d387f3d`.
...
- **CC5** — `lift-track-source-document-cm_v0.3.0.md` rename + ~140 cross-reference updates
- **CC6** — `lift-track-dispatch-handoff_v0.1.0.md` rename + semver bump
...
2. `lift-track-source-document-cm_v0.3.0.md` rename → `lift-track-source-document-cm_v0.3.0.md` + ~140 cross-reference updates
3. `lift-track-dispatch-handoff_v0.1.0.md` rename → `lift-track-dispatch-handoff_v0.1.0.md` + semver bump per CONVENTIONS §6.2
