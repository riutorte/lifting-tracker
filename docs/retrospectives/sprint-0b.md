...
- ✅ `architecture_v0.4.0.md` reflects all decisions — D8 revision, D19 Tier 2 concern log, D26 TypeScript, D27 multi-agent interop, four cross-cutting principles
- ✅ D25 + D28 ADRs landed
...
- ✅ Operational docs created (`metrics_v0.1.0.md`, `orchestration_v0.1.0.md`, `risks_v0.1.0.md`, `roadmap_v0.4.0.md` with timeline + mermaid gantt)
...
- `docs/architecture_v0.4.0.md` — D8 revision (SQLite + Drizzle + custom sync), D19 Tier 2 concern log, D26 TypeScript, D27 multi-agent interop promoted, D28 referenced, four cross-cutting principles (MCP-first, three-layer data, Railway hosting, HyperDX observability)
- `docs/adrs/D25-source-document-cm_v0.1.0.md`
- `docs/adrs/D28-architectural-discipline-profile_v0.1.0.md`
...
- `docs/risks_v0.1.0.md`
- `docs/roadmap_v0.4.0.md` — timeline + mermaid gantt

**DoDAF views (10):**

- `docs/dodaf/AV-1-overview_v0.1.0.md`
- `docs/dodaf/AV-2-dictionary_v0.1.0.md`
- `docs/dodaf/OV-1-concept-graphic_v0.1.0.md`
- `docs/dodaf/OV-5c-activity-sequence_v0.1.0.md`
- `docs/dodaf/CV-capabilities_v0.1.0.md`
- `docs/dodaf/SV-1-interfaces_v0.1.0.md`
- `docs/dodaf/SV-6-data-exchanges_v0.1.0.md`
- `docs/dodaf/SvcV-1-services-context_v0.1.0.md`
- `docs/dodaf/DIV-2-logical-data_v0.1.0.md`
- `docs/dodaf/StdV-1-standards_v0.1.0.md`
...
- `docs/reference/architecture-v0.3-to-v0.4-audit.md` — formal content-drop audit confirming zero drops across architecture revision
...
5. DoDAF cross-reference matrix — `docs/dodaf-cross-reference.md` linking user stories + sprints + DoDAF views + decisions
6. Reach4All bindfs residue cleanup (`.git.broken`, `test1.txt`)
7. `architecture-v0.3-to-v0.4-audit.md` → migrate to `reach4all/docs/operational/`
...
12. `source-doc-cm-design.md` rename to `_v<version>.md` + ~140 cross-reference updates (deferred from Sprint 0b)
