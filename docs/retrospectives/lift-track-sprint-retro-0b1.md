...
- Cross-reference updates in `docs/dodaf/AV-2-dictionary_v0.1.0.md`, `docs/dodaf/lift-track-dodaf-OV-1-concept-graphic_v0.1.0.md`, `docs/dodaf/lift-track-dodaf-SV-6-data-exchanges_v0.1.0.md`, `docs/dodaf/lift-track-dodaf-StdV-1-standards_v0.1.0.md`, `docs/adrs/lift-track-D28-architectural-discipline-profile_v0.1.0.md`
...
8. Kanban semver bump per the new §8 rule (pending naming-convention decision: kanban_v0.5.0.md vs lift-track-kanban-sprint-0b2.md)

Items deferred to Sprint 0c:

- `lift-track-source-document-cm_v0.3.0.md` rename to satisfy filename versioning convention + ~140 cross-reference updates
- `lift-track-architecture-v0.3-to-v0.4-audit_v0.1.0.md` misclassification fix (research-class file in operational location)
