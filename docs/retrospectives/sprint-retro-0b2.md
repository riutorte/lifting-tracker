...
- `docs/retrospectives/sprint-retro-0b1.md` (rename of sprint-0b1.md)
- `docs/retrospectives/sprint-retro-0b.md` (rename of sprint-0b.md)
- `docs/retrospectives/sprint-retro-0a.md` (rename of sprint-0a.md)
- `docs/retrospectives/sprint-retro-0b2.md` (this file)
- `docs/retrospectives/README_v0.1.0.md` (updated for new naming convention)
- `docs/kanban-sprint-0b2.md` (rename of kanban.md, frozen as 0b2 close state)
- ~80 cross-reference rewrites across `docs/kanban`, `docs/risks_v0.1.0.md`, `docs/reference/source-doc-cm-design.md`, `docs/architecture_v0.4.0.md`, `docs/adrs/D25-source-document-cm_v0.1.0.md`, `docs/orchestration_v0.1.0.md`, `docs/roadmap_v0.4.0.md`, `docs/metrics_v0.1.0.md`
...
- **Sprint 0b1 retro filename was wrong on first authoring.** Wrote `sprint-0b1.md` per the §6.2 convention as it stood at v0.2.2. Eric's pushback on type-indicator made it `sprint-retro-0b1.md`. Both the file rename AND the §6.2 amendment landed in 0b2 close.
...
4. **Promote source-doc-cm-design.md to versioned filename.** Currently `docs/reference/source-doc-cm-design.md` (no version) — should be `source-document-cm-design_v0.3.0.md` per §6.1+§8. Triggers ~140 cross-reference updates portfolio-wide. Originally Sprint 0c cleanup-queue item 2; rolled forward.
5. **Move `architecture-v0.3-to-v0.4-audit.md` to operational location.** Currently in `docs/reference/` (research-classified path) but content is operational (audit of architecture migration). Reclassify per §3.7 invariant 3 (cross-class migration is an ADR — short ADR or just a move with rationale in commit message).
6. **Retire dispatch-handoff.md → dispatch-handoff_v0.1.0.md.** Per §6.2 amendment, semver applies. Trivial rename.
...
1. `source-doc-cm-design.md` rename to `source-document-cm-design_v0.3.0.md` + ~140 cross-reference updates (carryover from 0b cleanup queue)
2. `architecture-v0.3-to-v0.4-audit.md` misclassification fix — move to operational location
3. Status-vocab consistency settle between CONVENTIONS and orchestration
4. `dispatch-handoff.md` → `dispatch-handoff_v0.1.0.md` rename per §6.2 v0.2.3 amendment
...
12. New kanban file `kanban-sprint-0c.md` created at sprint open with explicit open-items migration
