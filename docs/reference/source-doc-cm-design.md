...
**Defenses applied to this revision.** Baseline snapshot taken to `.baseline-v0.3.0-amendment1-20260423.md` before the first edit; Fresh-Read before every Edit; Edit not Write; Read-after-Write verification after each change. The four §5.7 defenses self-applied.
