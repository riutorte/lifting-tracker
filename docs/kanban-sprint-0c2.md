...
|---|---|---|
| (Placeholder. Populate at 0c2 sprint-open commit by reviewing frozen `kanban-sprint-0c1.md` Done / Open / Carry-forward state.) | — | — |
...
- Prior sprint's kanban (frozen at 0c1 close): `docs/kanban-sprint-0c1.md` (or `docs/lift-track-kanban-sprint-0c1.md` if rename pass landed)
...
- Sprint 0d (next sprint, opens at 0c2 close): pre-drafted in `docs/kanban-sprint-0d.md`
