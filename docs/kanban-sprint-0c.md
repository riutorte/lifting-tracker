...
Per CONVENTIONS_v0.2.3.md §8 + §14.2, this is Sprint 0c's per-sprint kanban. Created at sprint open with explicit open-items migration from `kanban-sprint-0b2.md`. Frozen at sprint close as the immutable record.
...
- `docs/kanban-sprint-0c.md` — this file (closed-state)
- `docs/kanban-sprint-0c1.md` — Sprint 0c1 open-state with 10 close criteria
- `docs/retrospectives/sprint-retro-0c.md` — this sprint's retro
...
Per §14.2 inheritance rule. Each item from `kanban-sprint-0b2.md` evaluated explicitly: bring-forward / defer / drop.
...
| Item | Source | Reason |
|---|---|---|
| architecture-v0.3-to-v0.4-audit.md misclassification fix | 0b2 → 0c carryover | Independent cleanup; not blocking 0c. |
...
| DoDAF cross-reference matrix (`docs/dodaf-cross-reference.md`) | 0b2 stretch goal | Promised in CONVENTIONS §11.6. |
...
- Prior sprint's kanban (frozen): `docs/kanban-sprint-0b2.md`
- Sprint 0b2 retrospective: `docs/retrospectives/sprint-retro-0b2.md`
- Sprint 0c retrospective at close: `docs/retrospectives/sprint-retro-0c.md`
...
- Roadmap context: `docs/roadmap_v0.4.0.md`
