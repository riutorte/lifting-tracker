...
4. **kanban-sprint-0c2.md draft** (open-state, ready when 0c2 opens):
...
5. **kanban-sprint-0d.md draft** (open-state):
...
6. **kanban-sprint-0e.md draft** (open-state):
...
**Plus:** Sprint 0c0.5 retrospective at close (`sprint-retro-0c0.5.md`).
...
### Defer to Sprint 0c1 (10 items per kanban-sprint-0c1.md)
...
- Sprint 0c0.5 retrospective at close: `docs/retrospectives/sprint-retro-0c0.5.md`
- Next sprint's kanban (after 0c0.5 close): `docs/kanban-sprint-0c1.md`
