...
2. NEW — `source-doc-cm-design.md` rename to `lift-track-source-document-cm_v0.3.0.md` + ~140 cross-reference updates portfolio-wide. Was 0c1 CC5; pulled into 0c1.5 with the broader rename pass.

3. NEW — `dispatch-handoff.md` rename to `lift-track-dispatch-handoff_v0.1.0.md` + semver bump per §6.2 v0.2.3 amendment. Was 0c1 CC6; pulled into 0c1.5.
...
- Prior sprint's kanban (frozen at 0c1 close): `docs/kanban-sprint-0c1.md`
- Sprint 0c1 retrospective: `docs/retrospectives/sprint-retro-0c1.md`
- Sprint 0c1.5 retrospective at close: `docs/retrospectives/sprint-retro-0c1.5.md`
- Next sprint's kanban (after 0c1.5 close): `docs/kanban-sprint-0c2.md`
