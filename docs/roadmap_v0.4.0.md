...
Reading order: `architecture_v0.4.0.md` → `user-stories_v0.2.0.md` → `themes-epics-features_v0.2.0.md` → this document.
...
| Backlog | Full schema deployment (all tables from architecture_v0.4.0.md D1–D24) | E1.1 | — | L | Supabase project |
