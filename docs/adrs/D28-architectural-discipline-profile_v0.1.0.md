...
- **Visual style standards.** Color, font, and layout conventions for diagrams are not specified here. They will be added to `CONVENTIONS_v0.2.0.md` if and when consistency-cost across views warrants it.
...
- `docs/CONVENTIONS_v0.2.0.md` — file structure and versioning rules; will be amended to add `docs/architecture/views/` once the first DoDAF view ships.
