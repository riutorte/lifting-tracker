...
- `docs/reference/lift-track-source-document-cm_v0.3.0.md` v0.3.0 §3.7 — Content Classes definition; the architecture class this profile produces under.
- `docs/lift-track-architecture_v0.4.0.md` v0.4.0 — D1–D27 plus D26 (TypeScript) and D27 (multi-agent interop). D28 will be added to this file's decisions list when the file is next touched.
...
- `docs/adrs/lift-track-D25-source-document-cm_v0.1.0.md` — the governance framework D28 composes with.
