...
This ADR was drafted 2026-04-24 (Sprint 0b Day 1) to give the decision a single-page summary linkable from other architecture documents. The authoritative detail remains in `docs/reference/lift-track-source-document-cm_v0.3.0.md` v0.3.0 (2,298 lines). If this ADR and the design brief disagree, the brief wins and this ADR is wrong — flag it and correct the ADR.
...
Adopt the Source-Document CM framework as specified in `docs/reference/lift-track-source-document-cm_v0.3.0.md` v0.3.0.
...
- `docs/reference/lift-track-source-document-cm_v0.3.0.md` — the full design brief (v0.3.0, 2,298 lines). Authoritative; this ADR summarizes it.
...
- `docs/retrospectives/lift-track-sprint-retro-0a.md` — sprint close; records the governance locks (Eric-only manual, Option B tags, native-tools-only, research-repo=`reach4all`).
- `docs/lift-track-architecture_v0.4.0.md` — D1–D24 plus D26 (TypeScript) and D27 (multi-agent interop) added in Sprint 0a.
...
| Date | Change |
|---|---|
| 2026-04-24 | ADR created (Sprint 0b Day 1). Summarizes `lift-track-source-document-cm_v0.3.0.md` v0.3.0. |
