...
Derived from `lift-track-architecture_v0.4.0.md` (D1–D24). Organized by MVP phase and role. Each story follows: **As a [role], I want to [action] so that [benefit].**
...
- 2026-04-15: Initial version. Derived from lift-track-architecture_v0.4.0.md D1–D6.
