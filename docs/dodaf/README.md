...
| SV-1 Systems Interface Description | Systems, sub-systems, interfaces between them | `SV-1-interfaces_v0.1.0.md` |
| SV-6 Systems Resource Flow Matrix | Data and control exchanges between systems | `SV-6-data-exchanges_v0.1.0.md` |
| SvcV-1 Services Context | Service contracts, MCP servers, API surfaces | `SvcV-1-services-context_v0.1.0.md` |
| DIV-2 Logical Data Model | Logical-tier data model | `DIV-2-logical-data_v0.1.0.md` |
| StdV-1 Standards Profile | Standards Lifting Tracker commits to (protocols, schemas, regulatory) | `StdV-1-standards_v0.1.0.md` |
...
In Sprint 0c1.5 the rename pass adds a `lift-track-dodaf-` prefix to each view file (e.g., `AV-1-overview_v0.1.0.md` → `lift-track-dodaf-AV-1-overview_v0.1.0.md`) so out-of-context filenames identify both system and view-class. View-codes remain anchored at the start after the prefix.
...
- Architecture decisions the views inform: `../architecture_v0.4.0.md` (D-decisions)
- User stories the views cover: `../user-stories_v0.2.0.md` (US-### references)
- ADR D28 (architectural discipline profile): `../adrs/D28-architectural-discipline-profile_v0.1.0.md`
- Forthcoming: portfolio-level cross-reference matrix at `../dodaf-cross-reference.md` (per CONVENTIONS §11.6 promise; Sprint 0c1 stretch deliverable)
