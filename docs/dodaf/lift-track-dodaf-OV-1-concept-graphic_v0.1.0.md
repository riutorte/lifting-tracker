...
The earlier in-conversation portfolio diagram included the conversation-archive folder structure and the docs taxonomy. Those are formalized in CONVENTIONS_v0.2.4.md §4–§5 and do not earn their place in OV-1; they belong in a separate operational view if and when one is needed. The OV-1 here keeps the diagram focused on "what runs" and "who participates," leaving "where docs live" to CONVENTIONS_v0.2.4.md.
