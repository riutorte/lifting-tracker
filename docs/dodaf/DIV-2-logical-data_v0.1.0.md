...
DIV-2 catalogues all tables in the architecture_v0.4.0.md data model. It does not catalogue:
...
**Sprint of last revision:** Sprint 0b Day 1 (2026-04-24). Initial population from architecture_v0.4.0.md v0.4.0 data model section.
