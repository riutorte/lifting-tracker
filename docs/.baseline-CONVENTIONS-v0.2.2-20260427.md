...
- §6 amended bullet: Operational ledgers (`kanban.md`, `dispatch-handoff.md`) reverse from bare filenames to `<name>_v<version>.md` semver pattern. Reverses the prior "pure ledger" exemption to prevent silent overwrite.
