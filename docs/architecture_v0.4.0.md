...
**Rationale:** Type safety across the Expo app / Edge Function / MCP-server boundary, strong AI-codegen fluency, and a compatible-by-design relationship with the Drizzle ORM choice in D8. See `docs/reference/stack-validation.md` for the analysis. Confirmed 2026-04-23.
